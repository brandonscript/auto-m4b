...
def _make_ol_result(
    ...
    *,
    ...
    r.author_and_narrator_swapped = swapped
    return r


def _mock_ol_author(name: str, *, work_count: int = 10, score: float = 2.0) -> "MagicMock":
    from unittest.mock import MagicMock

    a = MagicMock()
    a.has_match = True
    a.name = name
    a.work_count = work_count
    a.score = MagicMock(return_value=score)
    return a

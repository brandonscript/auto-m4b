...
_disc_tracks = {"_files": ["Track 01.mp3", "Track 02.mp3"], "_dirs": {}}
mock_book_multi_disc_cd_n_full = {
    "mock_book_multi_disc_cd_n": {
        "_files": [],
        "_dirs": {f"cd {d}": deepcopy(_disc_tracks) for d in range(1, 10)},
    }
}
# isorted("CD1".."CD14") by str().lower() gives string-sort order: CD1,CD10..CD14,CD2..CD9
_cdn_order = ["CD1", "CD10", "CD11", "CD12", "CD13", "CD14"] + [f"CD{d}" for d in range(2, 10)]
mock_book_multi_disc_cdn_full = {
    "mock_book_multi_disc_cdn": {
        "_files": [],
        "_dirs": {k: deepcopy(_disc_tracks) for k in _cdn_order},
    }
}
mock_book_multi_disc_cdn_single_full = {
    "mock_book_multi_disc_cdn_single": {
        "_files": [],
        "_dirs": {k: {"_files": [f"{k}.mp3"], "_dirs": {}} for k in _cdn_order},
    }
}
mock_book_multi_disc_cdn_single_0_1 = {
    "mock_book_multi_disc_cdn_single": {"_files": [], "_dirs": {}},
}
